<template>
    ...
    <div class="pre-owned">
                                ...
                                <div class="parsys">
                                    <div class="richtext">
                                        <div class="   padding-2x-bottom width-90 text-left">
                                            ...
                                            <h1>二手叉车</h1>
                                            <h2>几乎满足任何需求的二手叉车</h2>
                                            <p>从最小的托盘搬运车到提升最高的三向叉车，Crown-科朗种类繁多的二手叉车可满足各种客户的需求。请联系当地经销商，了解附近的二手叉车。</p>
                                        </div>
                                ...
                                <div class="parsys">
                                    <div class="richtext">
                                        <div class="    width-100 text-left">
                                            <h3>持久耐用</h3>
                                            <p>Crown-科朗叉车按照持久耐用的标准精心设计和制造。因此，我们的二手叉车库存包含各种性能依然出色的托盘搬运车、叉车以及专用叉车。</p>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
        ...
        <div class="column">
            <div class="container-fluid background-grey-lightester ">
                <div class="container background-grey-lightester ">
                    <div class="clearfix row background-grey-lightester everyDevice text-black container-vertical-aligned  padding-2x-top  padding-2x-bottom" style="background-image: url('');background-repeat: no-repeat; background-size: cover; background-position: center center;">
                        <div class="col-sm-6 vertical-align-middle">
                            <div class="container-inner">
                                <div class="parsys">
                                    <div class="richtext">
        ...
        <div class="column">
            <div class="container-fluid  ">
                <div class="container  ">
                    <div class="clearfix row  everyDevice text-black container-vertical-aligned  no-padding-top  " style="background-image: url('');background-repeat: no-repeat; background-size: cover; background-position: center center;">
                        <div class="col-sm-6 vertical-align-middle">
                            <div class="container-inner">
                                <div class="parsys">
                                    <div class="imagecomponent">
                            ...
                            <div class="container-inner">
                                <div class="parsys">
                                    <div class="richtext">
                                        <div class="    width-100 text-left">
                                            <h3>本地支持和服务</h3>
                                            <p>我们可能在客户所在地设有二手叉车库存。与新叉车一样，本地分公司和经销商能够满足Crown-科朗二手叉车的任何服务需求。</p>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
