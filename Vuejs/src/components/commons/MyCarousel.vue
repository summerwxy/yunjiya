<template>
    <div class="carousel">
        ...
        <div class="component-carousel text-white carousel-max-height-lg carousel-max-height-md carousel-max-height-sm">
                                        ...
                                        <div class="clearfix row-child everyDevice text-white" style="background-image: url('/static/c/us-homepage-hero-1.jpg');background-repeat: no-repeat; background-size: cover; background-position: center center;">
                                            <div class="col-sm-12 ">
                                                <div class="container-inner">
                                                    <div class="parsys">
                                                        <div class="richtext">
                                                            <div class=" padding-4x-top  no-padding-bottom width-80 component-center">
                                                                <h2 style="text-align: center;">您的物料搬运设备和解决方案的提供者</h2>
                                                                <h2 style="text-align: center;">&nbsp;</h2>
                                                                <h4 style="text-align: center;">发现我们能够提供的帮助</h4>
                                        ...
                                        <div class="clearfix row-child background-black desktopTabletOnly text-white" style="background-image: url('/static/c/fc-homepage-hero.jpg');background-repeat: no-repeat; background-size: cover; background-position: center center;">
                                            <div class="col-sm-6 ">
                                                <div class="container-inner">
                                                    <div class="parsys">
                                                        <div class="richtext">
                                                            <div class="padding-8x-top width-100 component-center">
                                                                <h2 style="text-align: center;">一举一动都体现着<br>作业效率</h2>
                                                            </div>
                                                            <div class="clearfix">
                                                            </div>
                                                        </div>
                                                        <div class="richtext">
                                                            <div class="width-100 component-center">
                                                                <h2 style="text-align: center;">FC 5200<b>系列</b></h2>
                                                            </div>
                                                            <div class="clearfix">
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-sm-6 ">
                                                <div class="container-inner">
                                                    <div class="parsys">
                                                        ...
                                                        <div class="calltoactionbutton">
                                                            <div class="Left padding-2x-left padding-2x-top   ">
                                                                <a href="http://www.crown.com/zh-cn/fleet-management/infolink.html" class="btn btn-cta text-white background-orange">了解更多</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-6 ">
                                                <div class="container-inner">
                                                    <div class="parsys">
                                                        ...
                                                        <div class="calltoactionbutton">
                                                            <div class="text-center padding-2x-top">
                                                                <a href="http://www.crown.com/zh-cn/forklifts/sc-sit-down-counterbalanced-truck.html" class="btn btn-cta text-white background-orange">了解更多</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
