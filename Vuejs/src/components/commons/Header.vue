<template>
                        ...
                        <nav class="navbar theme-nav-main" role="navigation">
                            ...
                            <div class="theme-container-nav">
                                <div class="navbar-header">
                                    <div class="nav-logo">
                                        <a class="navbar-brand theme-navbar-brand" href="zh-cn.html">
                                            <img class="img-responsive" src="http://www.crown.com/content/zh-cn/_jcr_content/header/header/logo.img.png/1446143018222.png" alt="Crown Equipment Corporation" title="Crown" data-emptytext="Logo"/>
                                        </a>
                                    </div>
  ...
  <div class="collapse navbar-collapse theme-navbar-collapse " id="navbar-main">< ! - -  removed from class: navbar-left  - -  >
